          ...
          <div class="col-lg-7 mx-auto text-white">
            ...
            <div class="row mt-5">
              <div class="col-12 mt-xl-2">
                <p class="text-white font-weight-medium text-center">Copyright © 2021. Todos los derechos reservados <a href="https://www.facebook.com/puellesyou/">La Marqueza</a></p>
              </div>
            </div>
          </div>
        </div>
