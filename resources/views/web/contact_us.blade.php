...
@section('content')
                    ...
                    <div class="contact-message">
                        ...
                        <form action="{{ route('contact.mail.store') }}" method="post" class="contact-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <input name="contact_email_address" placeholder="Correo electrónico *" type="text"
                                        required>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                ...
                <div class="col-lg-6">
                    <div class="contact-info mt-md-28 mt-sm-28">
                        ...
                        <ul>
                            ...
                            <li><i class="fa fa-envelope-o"></i> Correo : {{ $web_company->email }}</li>
                            <li><i class="fa fa-phone"></i> Teléfono : {{ $web_company->phone }}</li>
                        </ul>
    ...
    <div class="map-area-wrapper">
        <div class="container">
            ...
            <div id="map_content" data-lat="{{ $web_company->latitude }}" data-lng="{{ $web_company->length }}"
                data-zoom="18" data-maptitle="{{ $web_company->name }}" data-mapaddress="{{ $web_company->address }}">
