        ...
        <div class="col-lg-{{$col_2}}">
            <div class="product-details-des mt-md-34 mt-sm-34">
                ...
                <div class="share-icon mt-20">
                    ...
                    <a target="_blank"  class="twitter" href="https://twitter.com/intent/tweet?url={{ request()->fullUrl() }}&text={{$product->name}}&via={{ config('app.name', 'La Marquez') }}&hashtags={{ config('app.name', 'La Marqueza') }}"><i class="fa fa-twitter"></i>Twitter</a>
