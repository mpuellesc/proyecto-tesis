        ...
        <li class="nav-item nav-profile">
            <div class="nav-link">
                <div class="profile-image">
                    <img src="{{asset('melody/images/faces/face21.jpg')}}" alt="image" />
                </div>
        ...
        {{-- <li class="nav-item">
            ...
            <div class="collapse" id="contabilidad">
                <ul class="nav flex-column sub-menu">
                    @can('products.index')
                    <li class="nav-item d-none d-lg-block">
                        <a class="nav-link" href="{{route('products.index')}}">Caja</a>
                    </li>
                    @endcan
                    @can('categories.index')
                    <li class="nav-item">
                    ...
                    @can('tags.index')
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('tags.index')}}">Cuentas</a>
                    </li>
                    @endcan
                    @can('brands.index')
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('brands.index')}}">Balance General</a>
                    </li>
                    @endcan
                </ul>
            </div>
