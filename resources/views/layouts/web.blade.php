                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-5">
                            <div class="header-call-action">
                                ...
                                <a href="https://wa.me/921895639" target="_blank" rel="noopener noreferrer">
                                                ...
                                                <div class="dropdown header-top-dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="myaccount">
                                                        <a class="dropdown-item" href="{{ route('web.my_account') }}">Mi
                                                            cuenta</a>
                                                        <a class="dropdown-item" href="{{ route('web.orders') }}">
                                                            Pedidos</a>
                        ...
                        <div class="col-lg-3">
                            <div class="brand-logo">
                                <a href="{{ route('web.welcome') }}">
                                    <img src="{!! asset('galio/assets/img/logo/marqueza.png') !!}" alt="{{ $web_company->name }}"
                                        style="width:150px">
                                </a>
                            </div>
                        </div> <!-- end logo area -->
                                ...
                                <div class="header-middle-shipping mb-20">
                                    <div class="single-block-shipping">
                                        ...
                                        <div class="shipping-content">
                                            ...
                                            <span>Lun a Sab: 08.00 am - 18.00 pm</span>
                                        </div>
                                    ...
                                    <div class="single-block-shipping">
                                        ...
                                        <div class="shipping-content">
                                            <h5>envío gratis</h5>
                                            <span>En pedidos superiores a S/.199</span>
                                        </div>
                                    </div> <!-- end single shipping -->
                                    <div class="single-block-shipping">
                                        <div class="shipping-icon">
                    ...
                    <div class="footer-top-wrapper">
                        <div class="newsletter__wrap">
                            ...
                            <div class="newsletter__box">
                                <form action="{{ route('web.subscription_email') }}" method="POST">
                                    @csrf
                                    <input type="email" name="subscription_email" autocomplete="off"
                                        placeholder="Email">
                        ...
                        <div class="social-icons">
                            @foreach ($web_social_networks as $web_social_network)
                                <a href="{{ url($web_social_network->url) }}" data-toggle="tooltip"
                                    data-placement="top" title="{{ $web_social_network->name }}" target="_blank"><i
                                        class="fa {{ $web_social_network->icon }}"></i></a>
                            @endforeach
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="footer-widget mb-sm-26">
                                ...
                                <div class="widget-body">
                                    ...
                                    <a class="map-btn" href="{{ url($web_company->google_maps_link) }}"
                                        target="_blank">Abrir en Google Map</a>
                                </div>
                    ...
                    <div class="footer-bottom-wrap">
                        ...
                        <div class="payment-method-img">
                            @foreach ($web_payment_methods as $web_payment_method)
                                <img src="/{{ $web_payment_method->image }}"
                                    alt="{{ $web_payment_method->name }}">
                            @endforeach
                        </div>
                    </div>
                </div>
